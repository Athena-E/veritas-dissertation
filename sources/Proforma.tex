...
\begin{tabular}{ll}
  ...
  Title                     & A type-preserving compiler from a systems language to a Dependently Typed Assembly Language \\
  Examination               & Computer Science Tripos -- Part II, 2026                                                    \\
  Word Count                & 13,985\footnote{Counted using \texttt{texcount -inc -sum Dissertation.tex}}
  \\
  Code Line Count           & 42,996\footnote{Counted using \texttt{loc}}
  \\
...
I built Veritas as an end-to-end type-preserving toolchain: a source language with a parser and bidirectional refinement type checker, a typed SSA middle end, DTAL generation and optimisation, register allocation, physical-DTAL lowering, x86-64/ELF output, and an independent verifier. I significantly extended the core system with ownership and borrowing, region-backed arrays, runtime intrinsics, bare-metal output, and post-register-allocation verification. I evaluated the implementation and design of the language and compiler, and whether they uphold the intended trust architecture of Veritas.
