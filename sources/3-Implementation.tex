...
The verifier uses its own Z3 instance independent of the one used during compilation. The translation follows the same proof-by-refutation approach as the compiler's oracle (Section~\ref{sec:smt-oracle}).
