...
Veritas programs are written in \texttt{.veri} source files. The compiler and verifier is invoked from the command line. Figure~\ref{fig:cli-help} help output.
...
The resulting executable is a statically linked, freestanding ELF binary. The return value of \texttt{main} becomes the process exit code. 
