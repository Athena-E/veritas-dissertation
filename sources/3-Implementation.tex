...
The resulting executable is a statically linked, freestanding ELF binary. The return value of \texttt{main} becomes the process exit code; I did this to . 
...
\begin{figure}[h]
  ...
  \begin{tcolorbox}[colback=white, colframe=black, width=\textwidth, boxrule=0.5pt]
    ...
    \end{center}
  \end{tcolorbox}
  \caption{The Veritas compilation pipeline. Representations carrying checked type annotations are highlighted in blue.}
  \label{fig:pipeline}
\end{figure}
%
