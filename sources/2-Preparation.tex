...
This chapter establishes the conceptual and technical background for Veritas. It first introduces the type-theoretic foundations that motivate the project: type soundness, dependent and refinement types, bidirectional type checking, SMT-based proof discharge, and type-preserving compilation. It then places Veritas in the context of related work, particularly systems that trade off expressiveness, automation, and trust in different ways. The goal of the chapter is to give insight to existing ideas as well as make precise which of them Veritas does (or does not) adopt, and why those choices are appropriate for a project centred on independently verifiable systems code.
