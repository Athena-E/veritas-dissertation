...
leads into how they manifest in Veritas' implementation.
...
\subsection{Type-preserving compilation}\label{sec:dtal-background}
...
\subsection{Dependently Typed Assembly Language}\label{}
