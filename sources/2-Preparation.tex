...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black]
  \paragraph{Type checking} takes a context $\Gamma$, program $e$ and type $\tau$ as input and produces a true/false output reflecting whether $e$ is well-typed: $\Gamma \vdash e \leftarrow \tau$. \\

  \paragraph{Type synthesis} takes a context $\Gamma$ and program $e$ as input and produces a types $\tau$ as output: $\Gamma \vdash e \Rightarrow \tau$.
\end{tcolorbox}
% \begin{itemize}
